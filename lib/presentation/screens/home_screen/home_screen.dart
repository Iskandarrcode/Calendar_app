...
import 'package:tudo_app/presentation/widgets/calendar_screen_widgets/event_list_widget.dart';
              ...
              child: BlocBuilder<TodoEventsBloc, TodoEventsState>(
                ...
                builder: (context, state) {
                  ...
                  if (state is LoadedTodoEventState) {
                    ...
                    return EventList(events: filteredEvents, eventDateTimeInfo: _selectedDate);
                  }
